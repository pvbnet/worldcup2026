...
- `model/artifacts/evaluation/` — `match_metrics.json` (match-level WC 2022/2026 backtest) and `simulation_metrics.json` (2026 Monte Carlo scores). See [evaluation.md](evaluation.md). Regenerated by `python scripts/evaluate.py`.
