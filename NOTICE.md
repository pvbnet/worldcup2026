...
## Notes
This is a research project, not a hardened production service. Report issues to the repository owner ([pvbnet](https://github.com/pvbnet)).

This project is **not affiliated with FIFA**. FIFA ranking values are factual data compiled for research and modeling purposes only.
